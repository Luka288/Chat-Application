...
var U = class {
    ...
    static privateUserModel(e) {
      return {
        uid: e.uid,
        email: e.email,
        username: e.isAnonymous
          ? `Guest#${e.uid.substring(0, 4)}`
          : e.displayName,
        photoURL: e.photoURL,
        isAnonymous: e.isAnonymous ? "Anonymous" : "standard_user",
...
var we = class n {
  ...
  registerUser(e) {
    return f(this, null, function* () {
      try {
        let t = yield Ve(this.FireAuth, e.email, e.password);
        yield be(t.user, { displayName: e.username }),
          this.storeUsers(),
  ...
  loginUser(e) {
    return f(this, null, function* () {
      return De(this.FireAuth, e.email, e.password)
        .then(() => {
          this.router.navigateByUrl("/chats");
        })
        .catch((t) => {
          throw (
            (this.customAlerts.displayAlert("Error: Check fields", "error"), t)
          );
        });
    });
  }
  ...
  storeUsers() {
    return f(this, null, function* () {
      let e = this.FireAuth.currentUser;
      if (!e) return;
      let t = U.privateUserModel(e),
        i = k.publicUserModel(e),
        r = R(this.Fire, `users/${e.uid}`),
        s = R(this.Fire, `publicUser/${e.uid}`);
      try {
        yield te(r, t, { merge: !0 }), yield te(s, i, { merge: !0 });
      } catch (a) {
        console.error(a);
      }
    });
  ...
  static ɵprov = Z({ token: n, factory: n.ɵfac, providedIn: "root" });
};
var ke = (() => {
    class n {
      _renderer;
      ...
      static ɵfac = function (i) {
        return new (i || n)(o(K), o(Y));
      };
      static ɵdir = d({ type: n });
    }
    return n;
  })(),
  ot = (() => {
    class n extends ke {
      ...
      static ɵdir = d({ type: n, features: [g] });
    }
    return n;
  })(),
  Ge = new p("");
var at = { provide: Ge, useExisting: N(() => je), multi: !0 };
function lt() {
  let n = ee() ? ee().getUserAgent() : "";
    ...
    class n extends ke {
      ...
      constructor(t, i, r) {
        super(t, i),
          ...
          this._compositionMode == null && (this._compositionMode = !lt());
      }
      writeValue(t) {
        let i = t ?? "";
...
function ft(n) {
  return se(n.value) ? { required: !0 } : null;
}
function pt(n) {
  return n.value === !0 ? null : { required: !0 };
}
function gt(n) {
  return se(n.value) || dt.test(n.value) ? null : { email: !0 };
}
function mt(n) {
  return (e) => {
    let t = e.value?.length ?? oe(e.value);
    return t === null || t === 0
      ? null
      : t < n
...
function _t(n) {
  return (e) => {
    let t = e.value?.length ?? oe(e.value);
    return t !== null && t > n
      ? { maxlength: { requiredLength: n, actualLength: t } }
      : null;
  };
}
function vt(n) {
...
function ze(n) {
  return n.map((e) => (yt(e) ? e : (t) => e.validate(t)));
}
function Ze(n) {
  if (!n) return null;
  let e = n.filter(Le);
...
function Ye(n) {
  ...
  return e.length == 0
    ...
    : function (t) {
        let i = qe(t, e).map($e);
        return ce(i).pipe(de(We));
      };
}
function Ke(n) {
  return n != null ? Ye(ze(n)) : null;
}
function Ie(n, e) {
...
var T = class {
  ...
  An = u(l({}, Ct), { "[class.ng-submitted]": "isSubmitted" }),
  Mn = (() => {
    class n extends B {
      constructor(t) {
        super(t);
...
function Vt(n) {
  return Array.isArray(n) ? Xe(n) : n || null;
}
function tt(n, e) {
  return (q(e) ? e.asyncValidators : n) || null;
}
function Dt(n) {
...
function bt(n, e, t) {
  let i = n.controls;
  if (!(e ? Object.keys(i) : i).length) throw new S(1e3, "");
  if (!i[t]) throw new S(1001, "");
}
function At(n, e, t) {
  n._forEachChild((i, r) => {
    if (t[r] === void 0) throw new S(1002, "");
  });
}
var L = class {
    _pendingDirty = !1;
    ...
    get status() {
      return c(this.statusReactive);
    }
    set status(e) {
      c(() => this.statusReactive.set(e));
    }
    _status = D(() => this.statusReactive());
    ...
    errors;
    get pristine() {
      return c(this.pristineReactive);
    }
    set pristine(e) {
      c(() => this.pristineReactive.set(e));
    }
    _pristine = D(() => this.pristineReactive());
    pristineReactive = V(!0);
    get dirty() {
      return !this.pristine;
    }
    get touched() {
      return c(this.touchedReactive);
    }
    set touched(e) {
      c(() => this.touchedReactive.set(e));
    }
    _touched = D(() => this.touchedReactive());
    touchedReactive = V(!1);
    get untouched() {
      return !this.touched;
    }
    ...
    removeValidators(e) {
      this.setValidators(Ne(e, this._rawValidators));
    }
    removeAsyncValidators(e) {
      this.setAsyncValidators(Ne(e, this._rawAsyncValidators));
    }
    hasValidator(e) {
      return j(this._rawValidators, e);
    }
    hasAsyncValidator(e) {
      return j(this._rawAsyncValidators, e);
    }
    clearValidators() {
      this.validator = null;
    }
    ...
    markAsTouched(e = {}) {
      ...
      this._parent &&
        !e.onlySelf &&
        this._parent.markAsTouched(u(l({}, e), { sourceControl: i })),
        t && e.emitEvent !== !1 && this._events.next(new F(!0, i));
    }
    markAllAsTouched(e = {}) {
      this.markAsTouched({
        onlySelf: !0,
    ...
    markAsUntouched(e = {}) {
      ...
      this._forEachChild((r) => {
        ...
        t && e.emitEvent !== !1 && this._events.next(new F(!1, i));
    }
    markAsDirty(e = {}) {
      ...
      this._parent &&
        !e.onlySelf &&
        this._parent.markAsDirty(u(l({}, e), { sourceControl: i })),
        t && e.emitEvent !== !1 && this._events.next(new M(!1, i));
    }
    markAsPristine(e = {}) {
      ...
      this._forEachChild((r) => {
        ...
        t && e.emitEvent !== !1 && this._events.next(new M(!0, i));
    }
    markAsPending(e = {}) {
      this.status = _;
      let t = e.sourceControl ?? this;
      e.emitEvent !== !1 &&
        (this._events.next(new v(this.status, t)),
        this.statusChanges.emit(this.status)),
        this._parent &&
          !e.onlySelf &&
          this._parent.markAsPending(u(l({}, e), { sourceControl: t }));
    }
    disable(e = {}) {
      ...
      (this.status = A),
        (this.errors = null),
        this._forEachChild((r) => {
          r.disable(u(l({}, e), { onlySelf: !0 }));
        }),
        this._updateValue();
      let i = e.sourceControl ?? this;
      e.emitEvent !== !1 &&
        (this._events.next(new H(this.value, i)),
        this._events.next(new v(this.status, i)),
        this.valueChanges.emit(this.value),
        this.statusChanges.emit(this.status)),
        this._updateAncestors(u(l({}, e), { skipPristineCheck: t }), this),
    ...
    updateValueAndValidity(e = {}) {
      if ((this._setInitialStatus(), this._updateValue(), this.enabled)) {
        ...
        (this.errors = this._runValidator()),
          ...
          (this.status === b || this.status === _) &&
            this._runAsyncValidator(i, e.emitEvent);
      }
      let t = e.sourceControl ?? this;
      e.emitEvent !== !1 &&
        (this._events.next(new H(this.value, t)),
        this._events.next(new v(this.status, t)),
        this.valueChanges.emit(this.value),
        this.statusChanges.emit(this.status)),
        this._parent &&
    ...
    _setInitialStatus() {
      this.status = this._allControlsDisabled() ? A : b;
    }
    _runValidator() {
    ...
    _runAsyncValidator(e, t) {
      if (this.asyncValidator) {
        ...
        let i = $e(this.asyncValidator(this));
    ...
    _updateControlsErrors(e, t, i) {
      (this.status = this._calculateStatus()),
        ...
        (e || i) && this._events.next(new v(this.status, t)),
        this._parent && this._parent._updateControlsErrors(e, t, i);
    }
    _initObservables() {
      (this.valueChanges = new C()), (this.statusChanges = new C());
    }
    _calculateStatus() {
      return this._allControlsDisabled()
        ...
        : this.errors
        ? G
        : this._hasOwnPendingAsyncValidator || this._anyControlsHaveStatus(_)
        ? _
    ...
    _updatePristine(e, t) {
      ...
      (this.pristine = i),
        ...
        r && this._events.next(new M(this.pristine, t));
    }
    _updateTouched(e = {}, t) {
      (this.touched = this._anyControlsTouched()),
        this._events.next(new F(this.touched, t)),
    ...
    _setUpdateStrategy(e) {
      q(e) && e.updateOn != null && (this._updateOn = e.updateOn);
    }
...
var ae = new p("", { providedIn: "root", factory: () => z }),
  z = "always";
function Mt(n, e) {
  return [...e.path, n];
}
...
function W(n, e) {
  ...
  let i = () => {};
  return $(e._rawValidators, i), $(e._rawAsyncValidators, i), t;
}
function wt(n, e) {
  e.valueAccessor.registerOnChange((t) => {
    (n._pendingValue = t),
      (n._pendingChange = !0),
      (n._pendingDirty = !0),
      n.updateOn === "change" && nt(n, e);
  });
}
function Et(n, e) {
  e.valueAccessor.registerOnTouched(() => {
    (n._pendingTouched = !0),
      n.updateOn === "blur" && n._pendingChange && nt(n, e),
...
function xt(n) {
  return Object.getPrototypeOf(n.constructor) === ot;
}
function Pt(n, e) {
...
function Rt(n, e) {
  ...
  return (
    e.forEach((s) => {
      s.constructor === je ? (t = s) : xt(s) ? (i = s) : (r = s);
    }),
    r || i || t || null
  );
}
  ...
  constructor(e = null, t, i) {
    super(et(t), tt(i, t)),
      ...
      q(t) &&
        ...
        (Ue(e) ? (this.defaultValue = e.value) : (this.defaultValue = e));
  }
  setValue(e, t = {}) {
...
var it = new p("");
var jt = { provide: y, useExisting: N(() => Tt) },
  Tt = (() => {
    class n extends y {
      callSetDisabledState;
      get submitted() {
        return c(this._submittedReactive);
      }
      set submitted(t) {
        this._submittedReactive.set(t);
      }
      _submitted = D(() => this._submittedReactive());
      ...
      addControl(t) {
        ...
        return (
          xe(i, t, this.callSetDisabledState),
      ...
      removeControl(t) {
        Pe(t.control || null, t, !1), Ut(this.directives, t);
      }
      addFormGroup(t) {
      ...
      onSubmit(t) {
        return (
          ...
          Pt(this.form, this.directives),
          this.ngSubmit.emit(t),
          this.form._events.next(new ie(this.control)),
      ...
      resetForm(t = void 0) {
        this.form.reset(t),
          ...
          this.form._events.next(new re(this.form));
      }
      _updateDomValue() {
        this.directives.forEach((t) => {
          ...
          i !== r &&
            (Pe(i || null, t),
            Gt(r) && (xe(r, t, this.callSetDisabledState), (t.control = r)));
        }),
          this.form._updateTreeValidity({ emitEvent: !1 });
      }
      _setUpFormContainer(t) {
        let i = this.form.get(t.path);
        St(i, t), i.updateValueAndValidity({ emitEvent: !1 });
      }
      _cleanUpFormContainer(t) {
        if (this.form) {
          let i = this.form.get(t.path);
          i && Nt(i, t) && i.updateValueAndValidity({ emitEvent: !1 });
        }
      }
      ...
      _updateValidators() {
        le(this.form, this), this._oldForm && W(this._oldForm, this);
      }
      static ɵfac = function (i) {
        return new (i || n)(o(Te, 10), o(Be, 10), o(ae, 8));
      };
      static ɵdir = d({
        type: n,
        selectors: [["", "formGroup", ""]],
...
var Bt = { provide: w, useExisting: N(() => Ht) },
  Ht = (() => {
    class n extends w {
...
var In = (() => {
    class n {
      static withConfig(t) {
        return {
          ngModule: n,
          providers: [{ provide: ae, useValue: t.callSetDisabledState ?? z }],
        };
      }
      static ɵfac = function (i) {
        return new (i || n)();
      ...
      static withConfig(t) {
        return {
          ...
          providers: [
            ...
            { provide: ae, useValue: t.callSetDisabledState ?? z },
          ],
        };
      }
      static ɵfac = function (i) {
